...
//traps are gay command.
    if (command === '!trap') {
        message.channel.send('**' + user + '** thinks traps are gay!', {files: ["D:/BOT/gif/trap_1.gif"]});
    };

//traps aren't gay command.
    if (command === '!not') {
        message.channel.send('**' + user + '** thinks traps aren\'t gay!', {files: ["D:/BOT/gif/lol.gif"]});
    };
...
//Sends the invite link.
      ...
      if (command === "!tail"){
        message.channel.send("**" + user + "'s** tail waves back and forth!", {files:["D:/BOT/gif/wag_" + (Math.floor((Math.random() * 5) + 1)) + ".gif"]})
      };

      if (command === "!cry"){
        message.channel.send("**" + user + "** begins to cry!", {files:["D:/BOT/gif/cry_" + (Math.floor((Math.random() * 9) + 1)) + ".gif"]})
      };
...
//Emotes!
      if(message.channel.type === 'dm'){}
        ...
        if (command === "!pat"){
            if (targetUser === user){
              message.channel.send("**" + user + "** pats themself. For some reason.", {files: ["D:/BOT/gif/self_pat.gif"]});
            }else{
            message.channel.send("**" + targetUser + "** was pat by **" + user + "!**", {files: ["D:/BOT/gif/pat_" + (Math.floor((Math.random() * 5) + 1)) + ".gif"]});
          };
          if (targetUser === trapUser){
            setTimeout(function(){
            message.channel.send(":heart: I'll meow for you anytime, my love.");
        ...
        if (command === "!stab"){
          if (targetUser === trapUser){
            message.channel.send("**" + trapUser + "** stabs **" + user + "**! Omae wo shindeiru.", {files:["D:/BOT/gif/stab_" + (Math.floor((Math.random() * 5) + 1)) + ".gif"]})
          } else if (targetUser === user){
            message.channel.send("**" + user + "** stabs themselves dramatically!", {files:["D:/BOT/gif/self_stab.gif"]})
          }else{
            message.channel.send("**" + user + "** stabs **" + targetUser + "**!", {files:["D:/BOT/gif/stab_" + (Math.floor((Math.random() * 5) + 1)) + ".gif"]});
          };
        };

        if (command === "!thumbsup"){
          if (targetUser === user){
            message.author.send("Poor child, I'll give you a thumbs up!", {files:["D:/BOT/gif/thumb_" + (Math.floor((Math.random() * 5) + 1)) + ".gif"]})
          }else{
            message.channel.send("**" + user + "** gives **" + targetUser + "** a thumbs up!", {files:["D:/BOT/gif/thumb_" + (Math.floor((Math.random() * 5) + 1)) + ".gif"]})
          };
          if (targetUser === trapUser){
            setTimeout(function(){
              message.channel.send("Thanks!")
        ...
        if (command === "!kiss"){
          if (targetUser === trapUser){
              message.channel.send("**No!**", {files:["D:/BOT/gif/tsun_1.gif"]});
            } else if (targetUser === user){
            message.channel.send("Loneliness only goes so far, man.")
          }else{
            message.channel.send("**" + user + "** grabs **" + targetUser + "** and kisses them!", {files:["D:/BOT/gif/kiss_" + (Math.floor((Math.random() * 6) + 1)) + ".gif"]})
          }
        };

        if (command === "!pester"){
          if(targetUser === trapUser){
            message.channel.send("I'm listening, **" + user + "!**", {files:["D:/BOT/gif/felix/felix_ears.gif"]});
          } else if (targetUser === user){
            message.channel.send("You can't pester yourself!");
          } else {
            message.channel.send("**" + user + "** starts to pester **" + targetUser + "!**", {files:["D:/BOT/gif/annoy_" + (Math.floor((Math.random() * 6) + 1)) + ".gif"]})
          }
        };
        ...
        if (command === "!slap"){
          if(targetUser === trapUser){
            if (message.author.id === ownerID) {
              message.channel.send("**" + user + "** slaps **Me!** OW!", {files:["D:/BOT/gif/slap_" + (Math.floor((Math.random() * 6) + 1)) + ".gif"]})
            } else {
              message.channel.send("Why would you do that to me, **" + user + "**?", {files:["D:/BOT/gif/felix/felix_cry.gif"]})
            }
          } else if (targetUser === user){
            message.channel.send("Why are you hitting yourself?", {files:["D:/BOT/gif/felix/felix_cool.gif"]})
          } else {
            message.channel.send("**" + user + "** slapped **" + targetUser + "!**", {files:["D:/BOT/gif/slap_" + (Math.floor((Math.random() * 6) + 1)) + ".gif"]})
          }
        };
        if (command === "!smite"){
          if(message.author.id === ownerID){
            if(targetUser === trapUser){
              message.channel.send("MERCY! *Dies.*", {files:["D:/BOT/gif/smite_" + (Math.floor((Math.random() * 3) + 1)) + ".gif"]})
            } else {
              message.channel.send("**" + ownerUser + "** strikes **" + targetUser + "** down with lightning!", {files:["D:/BOT/gif/smite_" + (Math.floor((Math.random() * 3) + 1)) + ".gif"]})
            }
          }
        };
        if (command === "!hug"){
          if(targetUser === trapUser){
            message.channel.send("**" + user + "** hugs me! Yay!", {files:["D:/BOT/gif/hug_" + (Math.floor((Math.random() * 8) + 1)) + ".gif"]})
          } else if (targetUser === user){
            message.channel.send("If you're that lonely, I'll give you a hug~", {files:["D:/BOT/gif/felix/felix_wag.gif"]})
          } else {
            message.channel.send("**" + user + "** hugs **" + targetUser + "!**", {files:["D:/BOT/gif/hug_" + (Math.floor((Math.random() * 8) + 1)) + ".gif"]})
          }
        };
